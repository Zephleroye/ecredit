...
if(isset($_POST["submit"])){
	...
	if($approved_withdrawal == TRUE){
	
		$approved_withdrawal = 0;
	}
	$updateCustomerQuery = "UPDATE customer SET withdrawal_request = TRUE, approved_withdrawal = '$approved_withdrawal', code_2fa ='$code', amount = '$withdrawal_amount' WHERE id = '$id'";
    ...
    <script>
        $(document).ready(function() {
            setTimeout(function() {
                ...
                toastr.success('View your account details, and make a debit request from your eWallet ');
