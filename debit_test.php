...
<?php
		...
		$payment_time = time();
		$withdrawal_amount = $query_run['amount'];
		$code = $query_run['code_2fa'];
...
if(isset($_POST["validate"])){
	...
	try {
		...
		$message1 = "Wrong 2FA code entered! Enter the right 2FA-Code";
...
if(isset($_POST["resend"])){
	...
	$updateCustomerQuery = "UPDATE customer SET code_2fa ='$code' WHERE id = '$id'";
	...
	try {
		...
		$messageResponse = $messagingApi->sendQuickMessage("$bank_name", "$phone","Your new 2FA-Code is $code");
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <div class="row  border-bottom white-bg dashboard-header">
                    ...
                    <div class="col-sm-12">
                        <h3>You're almost there. Please enter 2FA code </h3>
				...
				<div class="modal inmodal" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
											...
											<div class="modal-content animated bounceInRight">
													<div class="modal-header">
														...
														</br><small class="font-bold">*** 2FA-Code lasts for 5 minutes and can be used only once ***</small>
													</div>
													<form method="POST" class="form-horizontal" >
													<div class="modal-body">
														<div class="form-group"><input type="number" name="input_2fa"  placeholder="Enter your 2FA here" class="form-control"></div>
													</div>
    ...
    <script>
        $(document).ready(function() {
            setTimeout(function() {
                ...
                toastr.success('Enter your 2FA code to send withdrawal request ');
