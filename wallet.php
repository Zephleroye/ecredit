...
if(isset($_POST["submit"])){
	...
	$payment_timestamp = date('Y-m-d H:i:s', time());
	
	$payment_amount = $_POST['payment_amount'];
	$temp_payment_amount = $_POST['payment_amount'];
	
	$payment_amount = $account_balance + $payment_amount;

	$updateCustomerQuery = "UPDATE customer SET payment_time = NOW(), payment_amount = '$temp_payment_amount', account_balance = '$payment_amount'  WHERE id = '$id'";
	...
	/*	$result = mysqli_query($conn, "SELECT * FROM admin WHERE id ='".$_SESSION['userid']."'");
		...
		*/
		...
		$messageResponse = $messagingApi->sendQuickMessage("eCredit", "$phone","A transaction of GHS $temp_payment_amount has been credited to your eWallet as of $payment_date");
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <div class="row  border-bottom white-bg dashboard-header">
                    ...
                    <div class="col-sm-12">
                        <h3>View your account details and make payment into your eWallet</h3>
		...
		<div class="row">
			...
			<div class="col-lg-7">	
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label" >Gh&#8373;</label>
                                    <div class="col-sm-8"><input type="number" disabled="" class="form-control" placeholder="Enter payment amount" name="payment_amount" required ="" >
                                    </div>
                                </div>
								...
								<div class="hr-line-dashed"></div>
								 <div class="form-group" >
                                    <div class="col-sm-4 col-sm-offset-3">
										...
										<button type="submit"  disabled="" class="btn btn-primary block full-width m-b" name="submit" >Confirm Payment</button>
    ...
    <script>
        $(document).ready(function() {
            setTimeout(function() {
                ...
                toastr.success('View the transaction on your account, payment feature yet to be integrated.');
